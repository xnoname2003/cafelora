...
1. User adalah entitas inti yang mewakili admin, staf kasir, dan customer. Akses kontrol diatur menggunakan role dan *permission*.
...
![alt text](images/ERDCafeloraFix.png)
